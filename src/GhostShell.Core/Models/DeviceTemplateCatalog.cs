...
public static class DeviceTemplateCatalog
{
    public static IReadOnlyList<DeviceTemplate> All { get; } = new[]
    {
        ...
        new DeviceTemplate {
            ...
            Os = DeviceOs.MacOs, IsLaptop = true,
        ...
        new DeviceTemplate {
            ...
            FormFactor = FormFactor.Mobile, Os = DeviceOs.IOs,
        ...
        new DeviceTemplate {
            ...
            FormFactor = FormFactor.Mobile, Os = DeviceOs.Android, UaModel = "Pixel 8 Pro",
        ...
        new DeviceTemplate {
            ...
            FormFactor = FormFactor.Mobile, Os = DeviceOs.Android, UaModel = "Pixel 9",
        ...
        new DeviceTemplate {
            ...
            FormFactor = FormFactor.Mobile, Os = DeviceOs.Android, UaModel = "SM-S928B",
        ...
        new DeviceTemplate {
            ...
            FormFactor = FormFactor.Mobile, Os = DeviceOs.Android, UaModel = "SM-S911B",
        ...
        new DeviceTemplate {
            ...
            FormFactor = FormFactor.Mobile, Os = DeviceOs.Android, UaModel = "SM-A546B",
            CpuCores = 8, RamGb = 6, GpuModel = "Mali-G68",
            ScreenWidth = 360, ScreenHeight = 780, Dpr = 3.0, Weight = 3,
        },
        new DeviceTemplate {
            Id = "xiaomi_14", HumanName = "Xiaomi 14",
            FormFactor = FormFactor.Mobile, Os = DeviceOs.Android, UaModel = "23127PN0CG",
            CpuCores = 8, RamGb = 12, GpuModel = "Adreno 750",
            ScreenWidth = 393, ScreenHeight = 873, Dpr = 3.0, Weight = 2,
        },
        new DeviceTemplate {
            Id = "redmi_note_13", HumanName = "Xiaomi Redmi Note 13",
            FormFactor = FormFactor.Mobile, Os = DeviceOs.Android, UaModel = "23129RAA4G",
        ...
        new DeviceTemplate {
            ...
            FormFactor = FormFactor.Tablet, Os = DeviceOs.IOs,
